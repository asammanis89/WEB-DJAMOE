            ...
            <div class="relative h-96 grid grid-cols-3 gap-8 overflow-hidden client-logo-container">
                ...
                <div class="flex flex-col gap-8">
                    <div class="animate-scroll-up flex flex-col items-center gap-8">
                        ...
                        <img src="<?php echo e(asset('gambar/1_ASTON_REV.webp')); ?>" alt="Logo Aston Madiun" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_BANK JATIM_REV.webp')); ?>" alt="Logo Bank Jatim" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_DPRD_REV.webp')); ?>" alt="Logo DPRD Kota Madiun" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_IMS_REV.webp')); ?>" alt="Logo INKA Multi Solusi" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_ASTON_REV.webp')); ?>" alt="Logo Aston Madiun" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_BANK JATIM_REV.webp')); ?>" alt="Logo Bank Jatim" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_DPRD_REV.webp')); ?>" alt="Logo DPRD Kota Madiun" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_IMS_REV.webp')); ?>" alt="Logo INKA Multi Solusi" class="h-16 md:h-20 max-w-full filter grayscale invert">
                ...
                <div class="flex flex-col gap-8">
                    <div class="animate-scroll-down flex flex-col items-center gap-8">
                        <img src="<?php echo e(asset('gambar/1_INKA_REV.webp')); ?>" alt="Logo PT INKA" class="h-12 md:h-16 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_JNK_REV.webp')); ?>" alt="Logo Jasamarga" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_LANUD_REV.webp')); ?>" alt="Logo Lanud Iswahjudi" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_INKA_REV.webp')); ?>" alt="Logo PT INKA" class="h-12 md:h-16 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_JNK_REV.webp')); ?>" alt="Logo Jasamarga" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_LANUD_REV.webp')); ?>" alt="Logo Lanud Iswahjudi" class="h-20 md:h-24 max-w-full filter grayscale invert">
                    </div>
                ...
                <div class="flex flex-col gap-8">
                      <div class="animate-scroll-up flex flex-col items-center gap-8">
                        <img src="<?php echo e(asset('gambar/1_LOGO UNIPMA_REV.webp')); ?>" alt="Logo UNIPMA" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_PEMKOT_REV.webp')); ?>" alt="Logo Kota Madiun" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_INKA_REV.webp')); ?>" alt="Logo PT INKA" class="h-12 md:h-16 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_LOGO UNIPMA_REV.webp')); ?>" alt="Logo UNIPMA" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_PEMKOT_REV.webp')); ?>" alt="Logo Kota Madiun" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="<?php echo e(asset('gambar/1_BANK JATIM_REV.webp')); ?>" alt="Logo Bank Jatim" class="h-16 md:h-20 max-w-full filter grayscale invert">
