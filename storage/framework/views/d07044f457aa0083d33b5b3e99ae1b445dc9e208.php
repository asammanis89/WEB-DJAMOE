...
<?php $__env->startSection('content_header_title', 'Edit Produk'); ?>
...
unset($__errorArgs, $__bag); ?>" id="product_name" name="product_name" value="<?php echo e(old('product_name', $product->product_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <div class="mb-2"><img src="<?php echo e(asset('storage/' . $product->image_url)); ?>" alt="Current Image" class="img-thumbnail" width="150"></div>
...
unset($__errorArgs, $__bag); ?>" id="image_url" name="image_url">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="is_bestseller" name="is_bestseller" value="1" <?php echo e(old('is_bestseller', $product->is_bestseller) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 5\PROYEK TEKNOLOGI INFORMASI\PERTEMUAN 5\djamoe-web-template\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>