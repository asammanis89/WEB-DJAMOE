...
<?php $__env->startSection('title', "Temukan Kami - D'jamoe"); ?>
...
<section class="py-24">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-dark-card p-6 rounded-2xl shadow-lg flex flex-col reveal-animation" style="transition-delay: <?php echo e($loop->iteration * 100); ?>ms;">
                <h3 class="text-xl font-serif font-bold text-accent mb-3"><?php echo e($location->name); ?></h3>
                ...
                <a href="<?php echo e($location->google_maps_url); ?>" target="_blank" class="mt-5 w-full text-center bg-primary/80 text-accent py-2.5 px-4 rounded-full hover:bg-accent hover:text-primary transition-colors duration-300 font-semibold text-sm">
                    Petunjuk Arah
                </a>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 5\PROYEK TEKNOLOGI INFORMASI\PERTEMUAN 5\djamoe-web-template\resources\views/outlet.blade.php ENDPATH**/ ?>