            ...
            <div class="col-lg-4 mb-4">
                <div class="welcome-card">
                    ...
                    <div class="d-flex flex-column">
                        <a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-light quick-action-btn mb-3">
                            <i class="fas fa-plus-circle mr-2"></i>Tambah Produk
                        </a>
                        <a href="<?php echo e(route('admin.articles.create')); ?>" class="btn btn-outline-light quick-action-btn">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 5\PROYEK TEKNOLOGI INFORMASI\PERTEMUAN 5\djamoe-web-template\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>