...
<?php $__env->startSection('title', 'Tambah Cerita'); ?>
<?php $__env->startSection('content_header_title', 'Tambah Cerita Baru'); ?>
    ...
    <form action="<?php echo e(route('admin.abouts.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control <?php $__errorArgs = ['year_text'];
...
unset($__errorArgs, $__bag); ?>" id="year_text" name="year_text" value="<?php echo e(old('year_text')); ?>" required>
                <?php $__errorArgs = ['year_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 5\PROYEK TEKNOLOGI INFORMASI\PERTEMUAN 5\djamoe-web-template\resources\views/admin/abouts/create.blade.php ENDPATH**/ ?>