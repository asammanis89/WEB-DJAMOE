...
.hero-swiper .swiper-slide {
    height: 100%; /* Menambahkan ini agar slide mengisi tinggi container */
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                @forelse($featuredProducts->take(4) as $product)
                    <div class="product-card bg-[#1a3a24] rounded-2xl shadow-lg h-full flex flex-col">
                        <img src="{{ asset('storage/' . $product->image_url) }}" alt="{{ $product->product_name }}" class="w-full h-80 object-cover rounded-t-2xl" loading="lazy">
                        <div class="p-6 text-center flex flex-col flex-grow">
                            <h3 class="text-xl font-serif font-bold mb-2 text-[#FBF8ED]">{{ $product->product_name }}</h3>
                            <div class="flex-grow"></div>
                            <a href="{{ route('produk.index') }}" class="mt-4 text-[#E6D793] font-semibold group">Lihat Detail <i data-lucide="arrow-right" class="inline w-4 h-4 transition-transform group-hover:translate-x-1"></i></a>
                        </div>
                    </div>
                @empty
...
<section class="py-20 bg-[#1a3a24]">
    <div class="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="reveal-animation text-center md:text-left">
            ...
            <a href="{{ route('about') }}" class="mt-8 inline-block bg-[#E6D793] text-[#154424] font-bold py-3 px-8 rounded-full hover:bg-opacity-90 transition-transform hover:scale-105">Baca Kisah Lengkap</a>
        </div>
    </div>
</section>
            ...
            <div class="relative h-96 grid grid-cols-3 gap-8 overflow-hidden client-logo-container">
                ...
                <div class="flex flex-col gap-8">
                    <div class="animate-scroll-up flex flex-col items-center gap-8">
                        {{-- --- PERBAIKAN BEST PRACTICE --- --}}
                        <img src="{{ asset('gambar/1_ASTON_REV.webp') }}" alt="Logo Aston Madiun" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_BANK JATIM_REV.webp') }}" alt="Logo Bank Jatim" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_DPRD_REV.webp') }}" alt="Logo DPRD Kota Madiun" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_IMS_REV.webp') }}" alt="Logo INKA Multi Solusi" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_ASTON_REV.webp') }}" alt="Logo Aston Madiun" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_BANK JATIM_REV.webp') }}" alt="Logo Bank Jatim" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_DPRD_REV.webp') }}" alt="Logo DPRD Kota Madiun" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_IMS_REV.webp') }}" alt="Logo INKA Multi Solusi" class="h-16 md:h-20 max-w-full filter grayscale invert">
                ...
                <div class="flex flex-col gap-8">
                    <div class="animate-scroll-down flex flex-col items-center gap-8">
                        <img src="{{ asset('gambar/1_INKA_REV.webp') }}" alt="Logo PT INKA" class="h-12 md:h-16 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_JNK_REV.webp') }}" alt="Logo Jasamarga" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_LANUD_REV.webp') }}" alt="Logo Lanud Iswahjudi" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_INKA_REV.webp') }}" alt="Logo PT INKA" class="h-12 md:h-16 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_JNK_REV.webp') }}" alt="Logo Jasamarga" class="h-16 md:h-20 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_LANUD_REV.webp') }}" alt="Logo Lanud Iswahjudi" class="h-20 md:h-24 max-w-full filter grayscale invert">
                    </div>
                ...
                <div class="flex flex-col gap-8">
                      <div class="animate-scroll-up flex flex-col items-center gap-8">
                        <img src="{{ asset('gambar/1_LOGO UNIPMA_REV.webp') }}" alt="Logo UNIPMA" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_PEMKOT_REV.webp') }}" alt="Logo Kota Madiun" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_INKA_REV.webp') }}" alt="Logo PT INKA" class="h-12 md:h-16 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_LOGO UNIPMA_REV.webp') }}" alt="Logo UNIPMA" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_PEMKOT_REV.webp') }}" alt="Logo Kota Madiun" class="h-20 md:h-24 max-w-full filter grayscale invert">
                        <img src="{{ asset('gambar/1_BANK JATIM_REV.webp') }}" alt="Logo Bank Jatim" class="h-16 md:h-20 max-w-full filter grayscale invert">
    ...
    <section id="outlet" class="py-20 bg-dark-card">
        <div class="container mx-auto px-4">
            ...
            <div class="mt-4 rounded-lg overflow-hidden shadow-2xl map-container border-4 border-primary/50 dark:border-accent/20 reveal-animation" style="transition-delay: 200ms;">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3954.442595011707!2d111.5310650748882!3d-7.635462892391696!2m3!1f0!2f0!3f0!3m2!i1024!2i768!4f13.1!3m3!1m2!1s0x2e79be94c7bef19b%3A0x2d581d8c40e4b01!2sJamu%20D&#39;jamoe%20Madiun!5e0!3m2!1sid!2sid!4v1727225131093!5m2!1sid!2sid"
...
@push('scripts')
{{-- Tidak perlu memanggil Swiper lagi di sini karena sudah ada di app.blade.php --}}
<script>
document.addEventListener('DOMContentLoaded', () => {
    // Inisialisasi Swiper hanya untuk halaman ini
    ...
    // Inisialisasi Lucide Icons sudah ada di app.blade.php, tidak perlu diulang
    // Inisialisasi Intersection Observer sudah ada di app.blade.php, tidak perlu diulang
});
</script>
@endpush
