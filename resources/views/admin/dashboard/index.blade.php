            ...
            <div class="col-lg-4 mb-4">
                <div class="welcome-card">
                    ...
                    <div class="d-flex flex-column">
                        <a href="{{ route('admin.products.create') }}" class="btn btn-light quick-action-btn mb-3">
                            <i class="fas fa-plus-circle mr-2"></i>Tambah Produk
                        </a>
                        <a href="{{ route('admin.articles.create') }}" class="btn btn-outline-light quick-action-btn">
                ...
                <div class="chart-card">
                    ...
                    <div class="mt-3">
                        <div class="legend-item">
                            ...
                            <span class="legend-value">{{ $totalProduk }}</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #059669;"></div>
                            <span class="legend-label">Kategori</span>
                            <span class="legend-value">{{ $totalKategori }}</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #34d399;"></div>
                            <span class="legend-label">Artikel</span>
                            <span class="legend-value">{{ $totalArtikel }}</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #6ee7b7;"></div>
                            <span class="legend-label">Pengguna</span>
                            <span class="legend-value">{{ $totalUsers }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="status-card p-4">
                    ...
                    <div class="status-item">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.abouts.index') }}" class="status-badge">
                    ...
                    <div class="status-item">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.locations.index') }}" class="status-badge">
                                Edit <i class="fas fa-chevron-right ml-1"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="status-item">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.flyers.index') }}" class="status-badge">
                                Edit <i class="fas fa-chevron-right ml-1"></i>
                            </a>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx) {
        new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ['Produk', 'Kategori', 'Artikel', 'Pengguna'],
                datasets: [{
                    data: [
                        {{ $totalProduk }},
                        {{ $totalKategori }},
